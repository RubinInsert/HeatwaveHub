...
const LEGEND_CONFIG: Record<string, { label: string; color: string }[]> = {
  exposure: [
  ...
  vulnerability: [
    { label: "Very Low", color: "#F7FCF0" },
    { label: "Low", color: "#E0F3DB" },
    { label: "Limited", color: "#CCEBC5" },
    { label: "Moderate", color: "#A8DDB5" },
    { label: "High", color: "#4EB3D3" },
    { label: "Very High", color: "#2B8CBE" },
    { label: "Severe", color: "#0868AC" },
    { label: "Extreme", color: "#084081" },
  ],
  // Use a generic "Risk" legend for SSP2 and SSP3
  risk: [
    { label: "Very Low Risk", color: "#3DA1D1" },
    { label: "Median Risk", color: "#75B3C3" },
    { label: "Severe Risk", color: "#9AC5B4" },
    { label: "Extreme Risk", color: "#B9D6A2" },
  ],
};
