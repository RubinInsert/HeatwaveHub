...
const questionsData = [
    ...
    },
    {
      ...
      options: [
        ...
        { label: "I live with others and feel that living space is limited", icon: "🌀", score: 1, slug: "i-live-with-others-and-feel-that-living-space-is-limited" },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Housemate/roommate", icon: "BR", score: -1, slug: "housemate-roommate" },
        { label: "Community organisation", icon: "🌀", score: -1, slug: "community-organisation" },
        ...
        { label: "Emergency service", icon: "🌀", score: -1, slug: "emergency-service" },
        { label: "Local council", icon: "🌀", score: -1, slug: "local-council" },
        { label: "Religious organisation", icon: "DT", score: -1, slug: "religious-organisation" },
    ...
    },
    {
      ...
      type: "RADIO",
      options: [
        { label: "Refrigerated air conditioning (e.g. split system, ducted air conditioning)", icon: "🛑", score: 1, slug: "refrigerated-air-conditioning-eg-split-system-ducted-air-conditioning" },
        { label: "Evaporative cooling", icon: "👕", score: 0.75, slug: "evaporative-cooling" },
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Apartment or unit (high-rise 4 or more storeys)", icon: "🏢", score: 0.25, slug: "apartment-or-unit-high-rise-4-or-more-storeys" },
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Lightweight cladding (e.g. metal or vinyl)", icon: "📐", score: 0.25, slug: "lightweight-cladding-eg-metal-or-vinyl" },
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Window tinting or reflective film", icon: "🏁", score: -1, slug: "window-tinting-or-reflective-film" },
        { label: "External window shading (e.g. awnings, shutters, external blinds)", icon: "🏁", score: -1, slug: "external-window-shading-eg-awnings-shutters-external-blinds" },
        { label: "None of the above", icon: "❌", score: 0, slug: "none-of-the-above" },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        { label: "Yes", icon: "✅", score: 1, slug: "yes" },
        { label: "No", icon: "❌", score: 0, slug: "no" },
        { label: "Does not apply (NA)", icon: "⚪", score: 0.5, slug: "does not-apply-na" },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        { label: "Taxi or rideshare", icon: "🚕", score: 0.33, slug: "taxi-or-rideshare" },
